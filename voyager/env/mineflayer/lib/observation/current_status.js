...
class CurrentStatus extends Observation {
    constructor(bot) {
        super(bot);
        this.name = "status";
    }
    ...
    observe() {
        return {
            current_health: this.bot.health,
            current_food: this.bot.food,
            current_oxygen: this.bot.oxygenLevel,
            current_velocity: this.getVelocity(),
    ...
    getVelocity()
    {
        ...
        return velocity.distanceTo(new Vec3(0, 0, 0));
    }
}
