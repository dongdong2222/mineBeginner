async function craftStoneTools(bot) {
  ...
  if (sticks < 5) {
    ...
    await moveBack(bot, "stick", 5 - sticks);
  }
  ...
  await moveBack(bot, "stone_sword", 1, craftingTablePosition);
  await moveBack(bot, "stone_axe", 1, craftingTablePosition);
  await moveBack(bot, "stone_shovel", 1, craftingTablePosition);
