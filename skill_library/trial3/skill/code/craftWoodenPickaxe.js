async function craftWoodenPickaxe(bot) {
  ...
  await moveBack(bot, "crafting_table", 1);
  ...
  await moveBack(bot, "oak_planks", 4, craftingTablePosition);
  ...
  if (sticks < 2) {
    ...
    await moveBack(bot, "stick", 2 - sticks, craftingTablePosition);
  }

  // Craft a wooden pickaxe using oak planks and sticks with the crafting table
  await moveBack(bot, "wooden_pickaxe", 1, craftingTablePosition);
